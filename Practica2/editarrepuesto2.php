...
if($referencia=='' or $descripcion=='' or $importe=='' or $porcentaje=='')
{
	echo " <h4>Error al modificar el repuesto en la Base de Datos, algun campo del formulario anterior es nulo.</h4><br>";
}
else{
...
$resultado=mysql_query("update repuestos set referencia='$referencia',descripcion='$descripcion',importe='$importe',porcentaje='$porcentaje',fotografia='$jpg' where referencia='$referencia'");
if($resultado==0)
{
echo " <h4>Error al modificar el repuesto en la Base de Datos.</h4><br>";

}
else
{
echo "<h4>El repuesto se ha modificado con &eacute;xito en la Base de Datos.</h4><br>";
}
}
else
{
	echo "<h4>No ha introducido ninguna foto nueva por lo que mantendra la anterior.</h4>";
$resultado=mysql_query("update repuestos set referencia='$referencia',descripcion='$descripcion',importe='$importe',porcentaje='$porcentaje' where referencia='$referencia'");
	if($resultado==0)
{
echo " <h4>Error al modificar el repuesto en la Base de Datos.</h4><br>";
}
...
<center>
<button type="button"onclick="location.href = 'gestionrepuestos.php'">Volver a gestion de repuestos</button> 
