...
$resultado=mysql_query("Delete from empleados where id_empleado='$idempleado'");
if($resultado==0)
{
...
if($error==0)
{
echo "<center><h4><br>El empleado se ha eliminado correctamente</center></h4></br>";
}
