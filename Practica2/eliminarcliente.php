...
{ 
echo "<script language='javascript'>alert('Debe seleccionar algun cliente para eliminar'); window.location.assign('gestionclientes.php') </script>"; 
}
else{
for($i=0;$i<count($array_borrados);$i++)
{ 
$resultado=mysql_query("Delete from clientes where id_cliente='$array_borrados[$i]'");
if($resultado==0)
{
echo "<center><h4><br>Error al eliminar el cliente de la base de datos </center></h4></br>";
$error=1;
}
}
if($error==0)
{
echo "<center><h4><br>Los clientes se han eliminado correctamente</center></h4></br>";
}
}
?>
