...
$resultado=mysql_query("Delete from vehiculos where matricula='$matricula'");
if($resultado==0)
{
...
if($error==0)
{
echo "<center><h4><br>El vehiculo se ha eliminado correctamente</center></h4></br>";
}
