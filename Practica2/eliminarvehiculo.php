...
{ 
echo "<script language='javascript'>alert('Debe seleccionar algun vehiculo para eliminar'); window.location.assign('gestionvehiculos.php') </script>"; 
}
else{
for($i=0;$i<count($array_borrados);$i++)
{ 
$resultado=mysql_query("Delete from vehiculos where matricula='$array_borrados[$i]'");
if($resultado==0)
{
echo "<center><h4><br>Error al eliminar el vehiculo de la base de datos </center></h4></br>";
$error=1;
}
}
if($error==0)
{
echo "<center><h4><br>Los vehiculos se han eliminado correctamente</center></h4></br>";
}
}
?>				
		<center>
