...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	<head>
		...
		<script type="text/javascript">
			...
			function enviar(pagina){
				document.repuestos.action = pagina;
				document.repuestos.submit();
				}
		</script>
	...
	<body>
		...
		<section>
				<div id="contenido">
				<h3><br>Gestion de repuestos:</h3></br>
				<center>
				<form method="post" name="repuestos" action="">
				<table>
				<tr bgcolor=orange>
				<td><font color=white><b>Editar</b></font></td>
				<td><b><font color=white><b>Referencia</font></b></td>
				<td><b><font color=white>Descripcion</b></font></td>
				<td><b><font color=white>Importe</font></b></td>
				<td><b><font color=white>Porcentaje</font></b></td>
				<td><b><font color=white>Fotografia</font></b></td>
				<td><b><font color=white><b>Eliminar</font></b></td>	
				
<?php 
include "conectar.php";

$resultado=mysql_query("Select * from repuestos");
if($resultado==0)
{
...
<a href=editarrepuesto.php?referencia=$referencia><img src=img/editar.jpg width=20></a></center></td>
<td><font size=2>$referencia</font></td>
<td><font size=2>$descripcion</font></td>
<td><font size=2>$importe</font></td>
<td><font size=2>$porcentaje</font></td>
<td><img src=$imagen width=50 border=0></td>
<td><input type=checkbox name=borrar[] value=$referencia>
</tr>";
}
else
{ 
...
<center>
<input type=submit value="Eliminar repuestos" onClick="enviar('eliminarrepuesto.php')">
<input type=reset value="Deseleccionar Todos">
<input type="button" value="Añadir repuesto" onClick="enviar('nuevorepuesto.php')">
</center>
</form>
</div>
</section>
