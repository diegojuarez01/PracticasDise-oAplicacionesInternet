...
$resultado=mysql_query("insert vehiculos(id_cliente,marca,anio,modelo,color,matricula) values ('$idcliente','$marca','$año','$modelo','$color','$matricula')");
if($resultado==0)
{
...
{
echo "<h4>El vehiculo se ha introducido con &eacute;xito en la Base de Datos.</h4><br>";
}
?>
					
<center>
<button type="button"onclick="location.href = 'nuevovehiculo.php'">Volver atras </button> 
