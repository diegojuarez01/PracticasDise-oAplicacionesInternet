...
if($marca=='' or $año=='' or $modelo=='' or $color=='' or $matricula=='')
{
	echo " <h4>Error al modificar el  vehiculo en la Base de Datos, algun campo del formulario anterior es nulo.</h4><br>";
}
else{
$resultado=mysql_query("update vehiculos set marca='$marca',anio='$año',modelo='$modelo',color='$color',matricula='$matricula',id_cliente='$idcliente' where matricula='$matricula'");
if($resultado==0)
{
echo " <h4>Error al modificar el vehiculo en la Base de Datos.</h4><br>";

}
else
{
echo "<h4>El vehiculo se ha modificado con &eacute;xito en la Base de Datos.</h4><br>";
}
}
?>
					
<center>
<button type="button"onclick="location.href = 'gestionvehiculos.php'">Volver a gestion de vehiculos </button> 
