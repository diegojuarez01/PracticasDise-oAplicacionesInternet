...
$email=$_POST["email"];
if($dni=='' or $nombre=='' or $apellido1=='' or $apellido2=='' or $direccion=='' or $cp=='' or $poblacion=='' or $provincia=='' or $telefono=='' or $email=='')
{
	echo " <h4>Error al modificar el cliente en la Base de Datos, algun campo del formulario anterior es nulo.</h4><br>";
}
else{
...
$resultado=mysql_query("update clientes set dni='$dni',nombre='$nombre',apellido1='$apellido1',apellido2='$apellido2',direccion='$direccion',cp='$cp',poblacion='$poblacion',provincia='$provincia',telefono='$telefono',email='$email',fotografia='$jpg' where id_cliente=$idcliente");
if($resultado==0)
{
echo " <h4>Error al modificar el cliente en la Base de Datos.</h4><br>";

}
else
{
echo "<h4>El cliente se ha modificado con &eacute;xito en la Base de Datos.</h4><br>";
}
}
else
{
	echo "<h4>No ha introducido ninguna foto nueva por lo que mantendra la anterior.</h4>";
	$resultado=mysql_query("update clientes set dni='$dni', nombre='$nombre', apellido1='$apellido1',apellido2='$apellido2', direccion='$direccion', cp='$cp',poblacion='$poblacion',provincia='$provincia',telefono='$telefono',email='$email' where id_cliente=$idcliente");
	if($resultado==0)
{
echo " <h4>Error al modificar el cliente en la Base de Datos.</h4><br>";
}
...
<center>
<button type="button"onclick="location.href = 'gestionclientes.php'">Volver a gestion de clientes </button> 
