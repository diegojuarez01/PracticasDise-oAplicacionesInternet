...
$resultado=mysql_query("Delete from repuestos where referencia='$referencia'");
if($resultado==0)
{
...
if($error==0)
{
echo "<center><h4><br>El repuesto se ha eliminado correctamente</center></h4></br>";
}
