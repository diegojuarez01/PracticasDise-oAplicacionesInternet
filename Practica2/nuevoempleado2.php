...
$resultado=mysql_query("insert empleados(dni,nombre,apellido1,apellido2,direccion,cp,poblacion,provincia,telefono,tipo,email,usuario,contrasenia,fotografia) values ('$dni','$nombre','$apellido1','$apellido2','$direccion','$cp','$poblacion','$provincia','$telefono','$tipo','$email','$usuario','$contraseña','$jpg')");
if($resultado==0)
{
...
{
echo "<h4>El empleado se ha introducido con &eacute;xito en la Base de Datos.</h4><br>";
}
?>

		
					
<center><button type="button"onclick="location.href = 'nuevoempleado.php'">Volver atras </button> 
