...
echo 		"<form method='post' name='vehiculos' action='nuevovehiculo2.php' enctype='multipart/form-data'>
			<center>
			...
			<font color='white'>IDCliente:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</font>
			<select name='cliente' required> <option selected disabled value=''>Seleccione idcliente</option>";	
...
<center><input type=submit value="Añadir vehiculo">
