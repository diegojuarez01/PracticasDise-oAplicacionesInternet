...
{ 
echo "<script language='javascript'>alert('Debe seleccionar alguna factura para eliminar'); window.location.assign('gestionfacturas.php') </script>"; 
}
else{
for($i=0;$i<count($array_borrados);$i++)
{ 
$resultado=mysql_query("Delete from factura where num_factura='$array_borrados[$i]'");
if($resultado==0)
{
echo "<center><h4><br>Error al eliminar la factura de la base de datos </center></h4></br>";
$error=1;
}
}
if($error==0)
{
echo "<center><h4><br>La o las facturas se han eliminado correctamente</center></h4></br>";
}
}
?>				
		<center>
