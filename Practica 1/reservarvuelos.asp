...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	-->
		...
		<section>
				...
				elseif ((origen<>"Todas") and (destino="Todas")) then
				...
				elseif ((origen = "Todas") and (destino<>"Todas")) then
					SentenciaSQL = "select * from LISTA_VUELOS_PRECIO where CIUDAD_DESTINO='" & ciudaddestino &"'"
				...
				elseif ((origen<>"Todas") and (destino<>"Todas")) then
					SentenciaSQL = "select * from LISTA_VUELOS_PRECIO where CIUDAD_ORIGEN='" & ciudadorigen &"' and CIUDAD_DESTINO='" & ciudaddestino &"'"
				end if
				...
				<div id="Formularioreserva" style="overflow-y: auto">
